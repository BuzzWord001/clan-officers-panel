...
(function () {
  ...
  function injectStyle() {
    ...
    st.id = "va-style";
    st.textContent =
      "#va-bar{position:fixed;top:8px;right:10px;z-index:2147483000;display:flex;align-items:center;gap:6px;" +
      ...
      "#va-tag{position:fixed;top:52px;right:10px;z-index:2147482999;max-width:260px;" +
