...
(function () {
  ...
  function titleArch(tgX) {
    ...
    var pts = [
      ...
      // конец хвоста — координаты из редактора (эскиз Лира), загиб книзу
      rnd(R + 389, B + 96),    // 0 свободный кончик (бусина-орб)
      rnd(R + 378, B + 81),    // 1
      rnd(R + 366, B + 69),    // 2
      rnd(R + 354, B + 60),    // 3
      rnd(R + 338, B + 58),    // 4 верх дуги конца
      rnd(R + 323, B + 62),    // 5
      rnd(R + 301, B + 73),    // 6 вход в дугу конца
      rnd(R + 215, B + 46),    // 7 гребень (волна к короне)
      rnd(R + 125, B + 78),    // 8 впадина
      rnd(R + 38,  B + 48),    // 9 гребень
      rnd(R - 34,  B + 72),    // 10 впадина (под правым краем заголовка)
      rnd(R + 4,   B + 6),     // 11 подъём к стыку
      // ---- правый бок и корона над заголовком ----
      rnd(R + 18, cy),             // правый бок (стык с короной)
