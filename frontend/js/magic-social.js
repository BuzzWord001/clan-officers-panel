...
(function () {
  ...
  function titleArch(tgX) {
    ...
    var pts = [
      ...
      rnd(R + 300, B + 84),    // 0 бусина — свободный конец (далеко справа, низ)
      rnd(R + 280, B + 68),    // 1 вверх от бусины
      rnd(R + 306, B + 52),    // 2 петелька кончика (завиток книзу)
      rnd(R + 215, B + 46),    // 3 гребень
      rnd(R + 125, B + 78),    // 4 впадина
      rnd(R + 38,  B + 48),    // 5 гребень
      rnd(R - 34,  B + 72),    // 6 впадина (под правым краем заголовка)
      rnd(R + 4,   B + 6),     // 7 подъём к стыку
