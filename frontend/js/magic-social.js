...
(function () {
  ...
  function titleArch(tgX) {
    ...
    var pts = [
      ...
      rnd(R + 432, B + 171),   // 0 свободный кончик (загиб книзу)
      rnd(R + 402, B + 145),   // 1 гребень конца
      rnd(R + 372, B + 150),   // 2
      rnd(R + 342, B + 167),   // 3
      rnd(R + 312, B + 180),   // 4
      rnd(R + 282, B + 189),   // 5
      rnd(R + 252, B + 194),   // 6
      rnd(R + 222, B + 198),   // 7 впадина
      rnd(R + 192, B + 198),   // 8
      rnd(R + 162, B + 183),   // 9
      rnd(R + 132, B + 148),   // 10
      rnd(R + 102, B + 130),   // 11
      rnd(R + 72,  B + 122),   // 12 гребень
      rnd(R + 42,  B + 128),   // 13
      rnd(R + 12,  B + 143),   // 14
      rnd(R - 18,  B + 154),   // 15 вход под заголовком (к стыку с короной)
