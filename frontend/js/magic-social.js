...
(function () {
  ...
  function titleArch(tgX) {
    ...
    var pts = [
      ...
      rnd(cx + 22,  B + 72),   // орб на кончике — завиток загнут КНИЗУ (низ)
      rnd(cx + 2,   B + 66),   // влево от орба
      rnd(cx - 4,   B + 52),   // вверх-влево (тело завитка)
      rnd(cx + 18,  B + 44),   // верх завитка — выход в свип
      rnd(cx + 120, B + 46),   // волна вправо под надписью
      rnd(cx + 232, B + 33),   // поднимается
