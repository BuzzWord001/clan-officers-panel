  ...
  const DICT = {
    ...
    "valor": {
      ...
      "Предупреждения": { fill: "mixed",
               what: "Все активные предупреждения человека в едином стиле. ТИП — буква в кружке: «%» норматив, «Т» титул (отметка офицера в игре), «Р» ручное (добавил офицер). СУРОВОСТЬ — цвет чипа: зелёный лёгкое, жёлтый среднее, красный суровое — зависит от того, сколько % нормы набрал.",
               how: "Норматив-предупреждение появляется за невыполненную неделю (суровость по % набранного). Когда человек выполняет норматив, первым снимается самое СУРОВОЕ. Кнопкой «+» офицер добавляет предупреждение вручную (любой суровости, снимается крестиком ✕). Титул — число, проставленное офицером в игре." },
