  ...
  const DICT = {
    ...
    "valor": {
      ...
      "Ценность": { fill: "calc", title: "Ценность для клана",
               what: "Общая полезность участника для клана, шкала 0–100 (выдающиеся могут быть выше 100 за счёт бонуса дисциплины — отмечены ★).",
               how: "Взвешенная сумма: доблесть — 60, ветеран — 16, офицер — 14 (высший пост за всё время + текущая должность), соцсети — 5, чаты — 5. ПЛЮС бонус дисциплины сверх 100: перевыполнение нормы (до +5), серия выполнений подряд (до +5) и безупречная история без провалов (+3). У новичков под иммунитетом доблесть исключается, итог нормализуется к 100." },
    },
