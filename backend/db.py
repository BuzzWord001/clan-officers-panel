...
CHAT_THEMES: dict[str, list[str]] = {
    ...
    # Добавлено 2026-05-29 после частотного анализа 9148 сообщений.
    # «кх» — Каньон Хаоса (данж PW), нулевой матч в текущем архиве, но
    # Лир попросил тему на будущее. Если КХ означает что-то другое —
    # стемы заменить на правильные.
    "кх":            ["кх", "каньон", "хаос"],
    "адепты":        ["адепт", "учен"],
    "приём":         ["прием", "приём", "набор", "вступ", "приним"],
    "баги":          ["баг", "лаг", "глюч", "вылет", "сломал", "крашит",
                      "не работает", "падает", "виснет"],
    "банк":          ["банк", "перевод", "рубл", "донат", "реал", "оплат"],
    "доблести":      ["добл"],
    "этапы":         ["этап"],
}
