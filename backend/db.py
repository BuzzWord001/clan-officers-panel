...
_CANON_OVERRIDE = {
    ...
    "__Hops__": "hopstwin",
    "__Hоps__": "hopstwin",
    # СнегоVик (кириллица С,н,е,г,о + лат.V + кир.и,к) читается «SnegoVik», но гомоглиф-канон
    # сворачивает по ФОРМЕ букв (С→c, н→h, г→r) в бессмысленное «cherovиk» и не совпадает с
    # его же ником «SnegoVik» в очереди (латиница→snegovik) → доблесть не находилась. Разводим
    # на общий канон snegovik, чтобы очередь и доблесть склеились в одного человека.
    "СнегоVик": "snegovik",
    # HARDKISS (латиница, Страж, «Аня») — ДЕЙСТВУЮЩИЙ игрок. НаRDKisS (кириллица
    # Н/а, Лучник) — ДРУГОЙ человек, давно ушёл из клана. Канон сворачивал оба
    # гомоглифа в один `hardkiss` → доблесть сливала их в одного и рисовала Аню
    # ником ушедшего. Разводим: HARDKISS → свой канон, НаRDKisS остаётся hardkiss
    # (там его старая история Лучника). Ключ — точное латинское написание Ани.
    "HARDKISS": "hardkissann",
}
